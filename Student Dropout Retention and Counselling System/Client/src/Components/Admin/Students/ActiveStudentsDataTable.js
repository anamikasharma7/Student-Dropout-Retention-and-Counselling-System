...
import { ActiveStudentServices } from "./ActiveStudentsServices";
...
export default function ActiveStudentsDataTable() {
  ...
  useEffect(() => {
    ActiveStudentServices.getCustomersXLarge(
      selectedState,
      selectedDistrict,
      selectedTaluka,
      selectedCity
  ...
  const PromoteHandler = () => {
    ...
    fetch(`http://localhost:3000/promteStudent`, requestOptions)
        ...
        <div>
          <div className="flex align-items-center justify-end gap-2 m-2 ">
            <Button
              ...
              onClick={exportExcel}
              data-pr-tooltip="XLS"
              className=" bg-orange-900 text-white hover:bg-orange-700 p-2 rounded-md"
          ...
          <div className="flex justify-between mr-2">
            ...
            {/* <Button
              ...
              label="Promote"
              outlined
              className="px-4 py-2  rounded-lg bg-orange-600 ring-0  hover:bg-orange-700 text-white tracking-wider font-bold uppercase"
            ...
            <span className="p-input-icon-left">
              <InputText
                ...
                className="p-2 ring-1 ring-opacity-50 ring-black focus:ring-orange-600 focus:ring-2 focus:ring-opacity-70 hover:ring-opacity-100 hover:ring-orange-400"
              />
            </span>
          </div>
        </div>
        ...
        >
          <div className="modal-above-screen bg-white rounded-lg p-4 relative">
            ...
            <div className="flex items-center justify-center">
              <button
                className="px-4 p-2 bg-orange-700 hover:bg-orange-500 rounded-lg font-bold text-white"
