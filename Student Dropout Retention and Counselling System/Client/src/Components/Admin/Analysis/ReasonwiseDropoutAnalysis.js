...
const ReasonwiseDropoutAnalysis = ({
  ...
  useEffect(() => {
    ...
    fetch(
      `http://localhost:3000/FilterStudentinGroupByTwo?state=${selectedState}&district=${selectedDistrict}&city=${selectedCity}&taluka=${selectedTaluka}&school&type1=Reasons&type2=null&standard=`,
      requestOptions
    )
