...
const ReasonwiseCasteAnalysis = ({
  ...
  useEffect(() => {
    ...
    fetch(
      `http://localhost:3000/FilterStudentinGroupByTwo?state=${selectedState}&district=${selectedDistrict}&city=${selectedCity}&taluka=${selectedTaluka}&type1=Reasons&type2=Caste&standard=${standard}`,
      requestOptions
    )
