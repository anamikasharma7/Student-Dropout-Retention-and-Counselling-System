...
const ReasonwiseFamilyIncomeAnalysis = ({
  ...
  const [chartData, setChartData] = useState({
    ...
    options: {
      ...
      colors: ["#f59e42", "#f97316", "#fbbf24", "#ea580c"],
      title: {
  ...
  useEffect(() => {
    ...
    fetch(
      `http://localhost:3000/FilterStudentinGroupByTwo?state=${selectedState}&district=${selectedDistrict}&city=${selectedCity}&taluka=${selectedTaluka}&type1=Reasons&type2=FamilyIncome&standard=${standard}`,
      requestOptions
    )
