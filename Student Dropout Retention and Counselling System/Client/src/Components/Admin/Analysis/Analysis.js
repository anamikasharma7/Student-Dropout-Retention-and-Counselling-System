      ...
      <div className="m-5">
        <div className="flex mb-5">
          <label className="w-1/4 m-4">
            <span className="text-amber-700 font-bold w-1/3">Select State</span>
            <select
              className="mt-1 p-2 w-full border border-orange-200 rounded-md focus:outline-2 focus:outline-orange-400 focus:border-orange-400 bg-white shadow-sm"
              value={selectedState}
              onChange={(e) => {
          ...
          <label className="w-1/4 m-4">
            <span className="text-amber-700 font-bold w-1/3">
              Select District
            </span>
            <select
              className="mt-1 p-2 w-full border border-orange-200 rounded-md focus:outline-2 focus:outline-orange-400 focus:border-orange-400 bg-white shadow-sm"
          ...
          <label className="w-1/4 m-4">
            <span className="text-amber-700 font-bold w-1/3">Select Taluka</span>
            <select
              className="mt-1 p-2 w-full border border-orange-200 rounded-md focus:outline-2 focus:outline-orange-400 focus:border-orange-400 bg-white shadow-sm"
          ...
          <label className="w-1/4 m-4">
            <span className="text-amber-700 font-bold w-1/3">Select City</span>
            <select
              className="mt-1 p-2 w-full border border-orange-200 rounded-md focus:outline-2 focus:outline-orange-400 focus:border-orange-400 bg-white shadow-sm"
              value={selectedCity}
              onChange={(e) => {
        ...
        <div className="flex">
          <label className="w-1/4 m-4">
            <span className="text-amber-700 font-bold w-1/3">Select Standard</span>
            <select
              className="mt-1 p-2 w-full border border-orange-200 rounded-md focus:outline-2 focus:outline-orange-400 focus:border-orange-400 bg-white shadow-sm"
              value={standard}
              onChange={(e) => {
          ...
          <label className="w-1/4 m-4">
            <span className="text-amber-700 font-bold w-1/3">Select Type</span>
            <select
              className="mt-1 p-2 w-full border border-orange-200 rounded-md focus:outline-2 focus:outline-orange-400 focus:border-orange-400 bg-white shadow-sm"
              value={flag}
              onChange={(e) => {
