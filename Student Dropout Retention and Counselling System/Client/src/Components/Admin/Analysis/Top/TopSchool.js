...
import { TopSchoolServices } from "./TopSchoolServices";
export default function TopSchool() {
  ...
  useEffect(() => {
    TopSchoolServices.getCustomersXLarge(
      selectedState,
      selectedDistrict,
      selectedTaluka,
      selectedCity
  ...
  const typeBodyTemplate = (rowData) => {
    if (rowData.school.Type === 0) {
      return <h1>Government</h1>;
    } else if (rowData.school.Type === 1) {
      return <h1>Private</h1>;
    } else if (rowData.school.Type === 2) {
      return <h1>Semin Government</h1>;
    } else if (rowData.school.Type === 3) {
