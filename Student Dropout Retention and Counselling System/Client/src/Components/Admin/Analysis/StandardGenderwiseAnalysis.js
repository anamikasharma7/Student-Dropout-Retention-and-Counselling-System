...
const StandardGenderwiseAnalysis = ({
  ...
  useEffect(() => {
    ...
    fetch(
      `http://localhost:3000/FilterStudentinGroupByTwo?state=${selectedState}&district=${selectedDistrict}&city=${selectedCity}&taluka=${selectedTaluka}&school&type1=Standard&type2=Gender`,
      requestOptions
    )
