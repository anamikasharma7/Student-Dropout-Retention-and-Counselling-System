        ...
        <div>
          <div className="flex align-items-center justify-end gap-2 m-2 ">
            <Button
              ...
              onClick={exportExcel}
              data-pr-tooltip="XLS"
              className=" bg-orange-600 text-white hover:bg-orange-700 p-2 rounded-md"
          ...
          <div className="flex justify-between mr-2">
            <Button
              ...
              label="Clear"
              outlined
              className="px-4 py-2 rounded-lg text-amber-800 ring-0 border-2 border-orange-700 hover:bg-orange-100"
              onClick={clearFilter}
            />
            {/* <Button
              type="button"
