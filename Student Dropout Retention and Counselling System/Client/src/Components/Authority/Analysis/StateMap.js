...
// Register FusionCharts dependencies
ReactFC.fcRoot(FusionCharts, FusionMaps, Rajasthan, FusionTheme);

// District code mapper for Rajasthan
const RajasthanDistrictCode = (district) => {
  switch (district) {
    case "Karauli": return "KA";
    case "Bikaner": return "BI";
    case "Churu": return "CR";
    case "Sikar": return "SK";
    case "Jaipur": return "JP";
    case "Dausa": return "DA";
    case "Jodhpur": return "JO";
    case "Pali": return "PA";
    case "Nagaur": return "NA";
    case "Tonk": return "TO";
    case "Barmer": return "BR";
    case "Rajsamand": return "RA";
    case "Ajmer": return "AJ";
    case "Sri Ganganagar": return "GA";
    case "Jalore": return "JL";
    case "Alwar": return "AL";
    case "Bharatpur": return "BP";
    case "Dholpur": return "DH";
    case "Sawai Madhopur": return "SM";
    case "Kota": return "KO";
    case "Bundi": return "BU";
    case "Baran": return "BN";
    case "Jhalawar": return "JW";
    case "Sirohi": return "SR";
    case "Jaisalmer": return "JS";
    case "Banswara": return "BW";
    case "Jhunjhunu": return "JJ";
    case "Hanumangarh": return "HA";
    case "Chittorgarh": return "CT";
    case "Udaipur": return "UD";
    case "Dungarpur": return "DU";
    case "Bhilwara": return "BH";
    case "Pratapgarh": return "PR";
    default: return "";
  }
};
...
const colorrange = {
  ...
  gradient: "1",
  color: [
    { maxvalue: "50", code: "#ffffff" },   // White
    { maxvalue: "200", code: "#FFEB3B" },  // Yellow
    { maxvalue: "400", code: "#4CAF50" },  // Green
    { maxvalue: "500", code: "#FF9800" },  // Orange
...
const StateMap = () => {
  const fakeData = [
    { district: "Jaipur", numOfStudent: 120 },
    { district: "Udaipur", numOfStudent: 125 },
    { district: "Jodhpur", numOfStudent: 530 },
    { district: "Ajmer", numOfStudent: 360 },
    { district: "Alwar", numOfStudent: 130 },
    { district: "Bikaner", numOfStudent: 535 },
    { district: "Bhilwara", numOfStudent: 530 },
    { district: "Chittorgarh", numOfStudent: 340 },
    { district: "Kota", numOfStudent: 530 },
    { district: "Sikar", numOfStudent: 600 },
    { district: "Nagaur", numOfStudent: 555 },
    { district: "Pali", numOfStudent: 465 },
    { district: "Tonk", numOfStudent: 356 },
    { district: "Banswara", numOfStudent: 165 },
    { district: "Dungarpur", numOfStudent: 360 },
    { district: "Jaisalmer", numOfStudent: 600 },
    { district: "Barmer", numOfStudent: 206 },
    { district: "Hanumangarh", numOfStudent: 28 },
    { district: "Sri Ganganagar", numOfStudent: 362 },
    { district: "Jhunjhunu", numOfStudent: 368 },
  ];

  // Map the data for FusionCharts
  const mappedData = fakeData.map((d) => ({
    id: `IN.RJ.${RajasthanDistrictCode(d.district)}`,
    value: d.numOfStudent,
  }));
  ...
  const chartConfigs = {
    ...
    dataSource: {
      chart: {
        ...
        caption: "Dropout Rate in Districts of Rajasthan",
        theme: "fusion",
      },
      colorrange: colorrange,
      data: mappedData, // prepopulate here
    },
  };
...
//     };
//     fetch(
//       `http://localhost:3000/DistrictWiseData?state=${stateId}&reason=${selectedReasons}&year=${selecYear}&caste=${selectedcast}&gender=${selectedGender}&standard=${selectedstandard}`,
//       requestOptions
//     )
