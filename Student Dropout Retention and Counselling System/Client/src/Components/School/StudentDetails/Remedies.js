...
const Remedies = () => {
  ...
  useEffect(() => {
    ...
    fetch(`http://localhost:3000/getReason?reason=${reason}`, requestOptions)
  ...
  useEffect(() => {
    ...
    fetch(`http://localhost:3000/customeSearch?q=${input}`, requestOptions)
      .then((response) => response.json())
      .then((result) => {
        console.log(result);
        setReason(result.data[0]);
                    ...
                    item.pdf.map((e) => (
                      <li>
                        ...
                        <a
                          ...
                          href={`http://localhost:3000/resources/${e.name}`}
